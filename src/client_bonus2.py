#!/usr/bin/env python3
"""
ClassChat Client - Bonus Task 5.2: File Transfer
Supports direct messaging, group chatting, and file transfer.
...
def receive_messages(client_socket, username):
    ...
    Handles direct messages, group messages, file transfers, and system notifications.
    """
    while True:
        try:
...
def start_client():
    """Start the ClassChat client with file transfer support"""
    client_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    
    try:
        # Connect to server
        print("=" * 60)
        print("ClassChat Client - Bonus 5.2: File Transfer")
        print("=" * 60)
